...
void EmptyLinkFunctionForGeneratedCodeAnimatedActor_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_AnimatedActor()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_AnimatedActor_AnimActorAnimTickSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AnimatedActor_AnimOverride__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/AnimatedActor",
				SingletonFuncArray,
